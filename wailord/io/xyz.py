...
class xyzVisitor(NodeVisitor):
    ...
    def generic_visit(self, node, visited_children):
        """
        Visit function for the given visitor.

        Args:
            self: (todo): write your description
            node: (todo): write your description
            visited_children: (todo): write your description
        """
...
class xyzIO:
    ...
    def write(self, outname):
        """
        Write the x y z coordinates to a file.

        Args:
            self: (todo): write your description
            outname: (str): write your description
        """
