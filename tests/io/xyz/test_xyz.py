...
def test_xyz(datadir):
    """
    Test that the xyz file is properly formatted.
...
def test_sysxyz(datadir):
    """
    Test that the xyzio system is the same as the one produced by the io module.
