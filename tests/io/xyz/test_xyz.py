...
def test_xyz(datadir):
    """
    Test the x y z coordinates of the x y coordinates.
...
def test_slugxyz(datadir):
    """
    Test if the given datadir is set
...
def test_sysxyz(datadir):
    """
    Test if the system test test test files.
...
def test_counts(datadir):
    """
    Count the number of test counts in a given datadir.
