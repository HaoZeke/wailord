#!/usr/bin/env python
#
# wailord documentation build configuration file, created by
...
import wailord  # noqa: F401 — package import for autodoc/apidoc
...
# the built documents.
#
# Prefer installed distribution metadata (hatch/pyproject); fall back for editable.
try:
    release = pkg_version("wailord")
...
latex_documents = [
    (master_doc, "wailord.tex", "Wailord Documentation", "Rohit Goswami", "manual"),
]
...
man_pages = [(master_doc, "wailord", "Wailord Documentation", [author], 1)]
